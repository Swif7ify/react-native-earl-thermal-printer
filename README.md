...
| :---------------------------- | :--------------------------------------------------------- | :-------------------- | :-------------------- | :---------------------------------------------------------------------------- |
| **`CODE128`** _(Recommended)_ | Tracking numbers, invoices, orders (`TRK-9988`, `INV-042`) | ✅ **Up to 24 chars** | ✅ **Up to 36 chars** | 🚀 **Highest density.** Thick 2-dot bars scan instantly on all phone cameras. |
